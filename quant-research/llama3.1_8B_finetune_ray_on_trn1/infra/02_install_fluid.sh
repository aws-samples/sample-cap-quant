...
echo "Waiting for Fluid CRDs to be registered..."
kubectl wait --for condition=established --timeout=60s crd/datasets.data.fluid.io
kubectl wait --for condition=established --timeout=60s crd/juicefsruntimes.data.fluid.io
